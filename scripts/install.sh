...
show_completion() {
    ...
    echo
    log_blue "下一步操作:"
    echo "1. 编辑配置文件: vim .env"
    echo "2. 填入Bot Token和管理员ID"
    echo "3. 启动服务: ./scripts/service.sh start"
    echo "4. 查看状态: ./scripts/service.sh status"
    echo "5. 查看日志: ./scripts/service.sh logs"
    echo
    log_blue "配置示例:"
